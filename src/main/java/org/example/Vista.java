...
public class Vista extends javax.swing.JFrame {
     ...
     */
    public Vista() {
        this.burbuja = new Burbuja(jProgressBar1, GeneradorDeVectores.vectorGrande(100000));
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       burbuja = new Burbuja(jProgressBar1, GeneradorDeVectores.vectorGrande(100000));
       burbuja.execute();
